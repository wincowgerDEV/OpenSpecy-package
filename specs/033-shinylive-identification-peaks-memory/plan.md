...
**Date**: 2026-09-14  
**Status**: File-backed threshold inspection and local CI regression repair complete; clean-commit hosted Actions remain maintainer-owned.
