...
.particle_material_palette <- function() {
  c(
    "mineral" = "#FC8EAC",
    "organic matter" = "pink",
    "cellulose derivatives" = "red",
    "cellulose derivatives (ether cellulose)" = "red",
    "polyacrylonitriles" = "darkblue",
