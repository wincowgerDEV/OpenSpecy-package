...
#' Classification Process for Identification of Microplastics Based on Fourier
#' Transform Infrared Spectroscopy." \emph{Applied Spectroscopy},
#' \strong{74}(9), 1167--1183. \doi{10.1177/0003702820923993}.
#'
