...
if (getRversion() >= "2.15.1") {
  utils::globalVariables(c(
    ...
    "..keep", "..test_required", ".library_order", ".N",
    ...
    "error_mode", "error_spectra", "expected", "expected_class",
    "expected_class_fraction", "expected_class_pct", "finding_count", "fit_max_cm1",
