...
Connected-region and clustering strategies collapse eligible pixels before
ordinary processing and identification. When correlation is itself a collapse
threshold, the app fully processes and identifies eligible pixels once, keeps
only the selected Top N results, and reuses their material identities while
forming and collapsing particles. Threshold failures are background pixels,
not unknown particles. The package-only experimental workflow above remains
available independently for research that needs bounded on-disk access.
