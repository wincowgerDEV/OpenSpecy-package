...
tutorial](https://raw.githack.com/wincowgerDEV/OpenSpecy-package/main/docs/app.html).
...
Tutorial](https://raw.githack.com/wincowgerDEV/OpenSpecy-package/main/docs/spectragryph.html). Unfortunately the maintainer of Spectragryph passed away and it is unclear how much longer this will be supported.
