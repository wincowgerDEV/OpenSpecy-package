...
the analysis, intensity values are min-max normalized:

$$\frac{x - \mathrm{min}(x)}{\mathrm{min}(x) - \mathrm{max}(x)}$$

\end{equation}ctra Plot
...
<!-- [![](images/image1.png)]{style="width: 620.60px"} -->
(Figures Courtesy of Bridget O\'Donnell from Horiba Scientific)

But, a closer look at the 1450 cm^-1^ band reveals
clear differences:

<!-- [![](images/image2.png)]{style="width: 616.57px"} -->

When you overlay them, you start to see differences in other spectral
regions too:

<!-- [![](images/image3.png)]{style="width: 624.00px"} -->
...
bottom):
<!-- [![](images/image4.png)]{style="width: 584.61px"} -->


The differences are even more pronounced when you overlay the
spectra:

<!-- [![](images/image5.png)]{style="width: 542.20px"} -->
