...
high intensities and non-peak regions should have low intensities. If preprocessing a spectral map or in batch, we recommend to tune the parameters so that you maximize the number of spectra over your signal to noise ratio before you start identification. Spectra below the signal to noise ratio will show up black. 
