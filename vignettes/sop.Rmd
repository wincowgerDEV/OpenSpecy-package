...
p1 <- smooth_intens(raman_hdpe, polynomial = 1, derivative = 0)
p4 <- smooth_intens(raman_hdpe, polynomial = 4, derivative = 0)
...
knitr::include_graphics("sop/baselinecorrectionpoly.jpg")
```
...
```{r, fig.align="center", echo=FALSE}
knitr::include_graphics("sop/rangeselection.jpg")
```
...
```{r, fig.align="center", echo=FALSE}
knitr::include_graphics("sop/flattten_example.jpg")
```
...
```{r, fig.align="center", echo=FALSE}
knitr::include_graphics("sop/identification.jpg")
```
