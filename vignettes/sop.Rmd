...
The default-on **Preserve Uploaded Wavenumbers** advanced control leaves the
uploaded axis unchanged and conforms the identification library onto it with
memory-bounded `mean_up` averaging and interpolation. Heatmap legends open from **View Legend**; categorical
