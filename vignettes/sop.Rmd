...
knitr::include_graphics("sop/mainpage.jpg")
```
...
```{r, fig.align="center", echo=FALSE}
knitr::include_graphics("sop/samplefile.jpg")
```
...
```{r, fig.align="center", echo=FALSE}
knitr::include_graphics("sop/spectra_vis.jpg")
```
...
```{r, fig.align="center", echo=FALSE}
knitr::include_graphics("sop/map_vis.jpg")
```
...
```{r, fig.align="center", echo=FALSE}
knitr::include_graphics("sop/processing.jpg")
```
...
```{r, fig.align="center", echo=FALSE}
knitr::include_graphics("sop/snr_threshold.jpg")
```
...
```{r, fig.align="center", echo=FALSE}
knitr::include_graphics("sop/download.jpg")
```
...
```{r, fig.align="center", echo=FALSE}
knitr::include_graphics("sop/flowchart.png")
```
