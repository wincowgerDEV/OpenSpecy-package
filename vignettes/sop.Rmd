...
none <- process_spec(raman_hdpe,adj_intens = F, conform_spec = F, restrict_range = F,flatten_range = F,subtr_baseline = F,smooth_intens = F, make_rel = T)
...
none <- process_spec(single,adj_intens = F, conform_spec = F, restrict_range = F,flatten_range = F,subtr_baseline = F,smooth_intens = F, make_rel = T)
...
none <- raman_hdpe
relative <- process_spec(raman_hdpe,adj_intens = F, conform_spec = F, restrict_range = F,flatten_range = F,subtr_baseline = F,smooth_intens = F, make_rel = T)
...
knitr::include_graphics("sop/matches.jpg")
```
