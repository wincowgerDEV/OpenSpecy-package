...
Spectral maps can also be visualized as overlaid spectra but in addition the spatial information can be plotted as a heatmap. 

```{r eval=FALSE}
heatmap_spec(spectral_map,
             z = spectral_map$metadata$x) #will show more advanced example later in tutorial.

interactive_plot(spectral_map, select = 1, z = spectral_map$metadata$x)
...
```{r, fig.align="center", echo=FALSE}
knitr::include_graphics("metadatainput.jpg")
```
