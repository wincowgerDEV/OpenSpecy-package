...
tutorial](https://wincowgerdev.github.io/OpenSpecy-package/pkgdown/articles/app.html).
...
[the embedded browser app](https://wincowgerdev.github.io/OpenSpecy-package/) or
...
Tutorial](https://wincowgerdev.github.io/OpenSpecy-package/pkgdown/articles/spectragryph.html). Unfortunately the maintainer of Spectragryph passed away and it is unclear how much longer this will be supported.
...
tile. This initial file-backed method supports only the `collapse` strategy,
`mean`, non-entropy S/N, and no spectral smoothing. Whole-map correlations,
raw-pixel matching, median/custom collapse, PCA/K-means fitting, and arbitrary
file-backed operation chains remain intentionally unavailable. Use bounded
materialization for those established operations, and verify equivalence on a
representative subset before interpreting a large run.
