...
a better understanding of every procedure involved in using the Open Specy R package
...
spectra at an average speed of 1 min^-1^ or faster with the new batch and automated procedures.
...
be shared under [CC-BY 4.0 license](https://creativecommons.org/licenses/by/4.0/) and will be available for
...
other is interactive. Here is an example of quick and efficient plotting.
