...
Each model stores a training-median filler and one tidy `tests` table.

Full assessment uses every candidate and downloaded legacy artifact, creates
one stable-identity-paired rounded ten-percent holdout allocated across
class/type strata, and gives old and new exactly
the same query IDs. Held-out reference spectra are removed before library
