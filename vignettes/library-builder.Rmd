...
separate; 2200--2420 cm^-1^ is excluded by default. Classes are never reduced
below `min_n`, constant or unmatched spectra are retained, and deterministic
IDs resolve correlation ties. Use `return = "report"` for the retained IDs,
frozen class schedule, reassignment correlations, and removals.
