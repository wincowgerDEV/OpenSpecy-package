...
The switch is unavailable for model classification.
...
Inside **Active retained spectrum**, **Show Peak Positions** is on by default.
Its 1--20 slider starts at 7 and updates the current processed spectrum without
another Run. Points mark interior positive-to-negative first-derivative zero
crossings, rank by displayed intensity, and are labeled in cm^-1^. Rejected
pixels and states without an active retained spectrum do not run peak finding.
