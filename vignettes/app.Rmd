...
The **Quantification** tab builds user-defined area or point ratios and is off
by default. Upload spectra, give a ratio a meaningful name, choose **Area
ratio** or **Peak ratio**, set the numerator and denominator, and click **Add
Ratio**. The sliders span the shared wavenumber axis in the final processed data. Add
...
before interpreting or comparing ratios; quantification does not run a second
preprocessing pipeline. Draft names and sliders do not start calculation; only
saved definitions are calculated after Quantification is enabled. Slider values
are whole-number wavenumbers over the final processed shared axis.

The saved area- and peak-ratio definitions, values, and processed-spectrum
source are added to the metadata in both **Processed Spectra** and **Top
Matches** downloads.
...
the saved ratio definitions, values, and processed-spectrum source are included in its
metadata.
...
saved-ratio provenance. The MD5 field describes the displayed processed
