...
WebAssembly/Shinylive app is built from the same bundled source and is pinned
to the matching OpenSpecy package plus Shiny app dependency set for that app
release. To keep the browser app small, it exposes the medoid and multinomial
model libraries; the local app can still use the full libraries.
