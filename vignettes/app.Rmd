...
download option. Top N controls the number of top matches to provide for each spectrum and Columns to Save will just save the simplest metadata for interpretation if set to simple or everything if set to all. When quantification is on, saved area and peak ratios, single-region areas, single-wavenumber intensities, and processed-spectrum provenance are included with the match metadata.
